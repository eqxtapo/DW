...
@method_decorator(
    name="create",
    decorator=swagger_auto_schema(operation_description="Cоздания пользователя"),
)
...
@method_decorator(
    name="retrieve",
    decorator=swagger_auto_schema(operation_description="Просмотр пользователя"),
)
@method_decorator(
    name="update",
    decorator=swagger_auto_schema(operation_description="Редактирование пользователя"),
)
@method_decorator(
    name="partial_update",
    decorator=swagger_auto_schema(
        operation_description="Частичное редактирование пользователя"
    ),
)
@method_decorator(
    name="destroy",
